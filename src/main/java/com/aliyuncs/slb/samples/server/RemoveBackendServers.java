...
/**
 * 移除后端服务器 https://help.aliyun.com/document_detail/27633.html
 *
 */
public class RemoveBackendServers {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (RemoveBackendServersResponse.BackendServer it : response.getBackendServers()) {
