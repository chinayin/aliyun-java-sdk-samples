...
本示例介绍如何使用阿里云Java SDK调用SLB的 DeleteLoadBalancerListener 接口，删除监听。

**说明：**
在调用该接口时，注意：
* 只有当监听的状态为stopped或者running时，才可以删除。
 ...
 * 删除监听
 *
 * @see https://help.aliyun.com/api/slb/DeleteLoadBalancerListener.html
 *
 */
